<script lang="ts">
    ...
    let selectedChapter = $derived(chapters.find(chapter => chapter.number === selectedChapterNumber) || chapters[0]);
...
<section class="landing-page-section default-margin">
    ...
    <div class="chapter-container">
        <ul>
            ...
            <li>
                <button onclick={() => selectChapter(chapter.number)} class="chapter-title"
        ...
        <div class="chapter-info">
            <h3 class="chapter-strapline italic mb-s">{selectedChapter.strapline}</h3>
